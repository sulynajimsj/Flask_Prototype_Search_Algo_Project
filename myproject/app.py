...
def main():
    ...
    reverseImageSearch.processVideo('ronaldo.mp4')
    imageUrls = reverseImageSearch.inputImages('frames')
    print(imageUrls)
...
def my_form_post():
    ...
    reverseImageSearch.searchAPI(text, "ede0f7899391ff6bcbab87e5169fb8dc794b21c59eac5aa9e0112b045a393d2d")
    return render_template('index.html')